...
//send the data of the socket to server
var io = socket(server);

//for start new connections
...
function newConnection(socket)
{
    ...
    function SendColor(data){
        socket.broadcast.emit('pencolor',data);
    ...
    {
        socket.broadcast.emit('Highlighter', data);
    }
    function changewidthdata(data)
    {
        socket.broadcast.emit('penwidth', data);
    }
...
function incomingCallResponse(calleeId, from, callResponse, calleeSdp, ws) {
    console.log("sasasasasas"+calleeId);
...
function call(callerId, to, from, sdpOffer) {
    console.log("aaaaaaaaaaaaaaaa"+callerId);
